...
namespace sdvk
{
    RenderPass::RenderPass(vk::Format swapchain_image_format, vk::Format depth_image_format, const Context& context)
    {
        std::vector<vk::AttachmentDescription> attachments = {
            make_color_attachment(swapchain_image_format),
            make_depth_attachment(depth_image_format)
        };
        ...
        auto result = context.device().createRenderPass(&create_info, nullptr, &m_render_pass);
    }

    vk::AttachmentDescription RenderPass::make_color_attachment(vk::Format swapchain_image_format)
    {
    ...
    vk::AttachmentDescription RenderPass::make_depth_attachment(vk::Format depth_image_format)
    {
        vk::AttachmentDescription depth_attachment;

        depth_attachment.setFormat(depth_image_format);
